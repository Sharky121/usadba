...
?>
	<div class="col-md-3 col-sm-6"><article class="latest-b">
	  <figure class="latest-img"><?php get_the_image( array( 'meta_key' => array( 'thumbnail', 'thumbnail' ), 'size' => 'easyweb_webnus_latestfromblog' ) );   ?></figure>
		...
		<p class="latest-author"><strong><?php esc_html_e('by','webnus-shortcodes') ?></strong> <?php the_author_posts_link(); ?> <strong><?php esc_html_e('in','webnus-shortcodes') ?></strong> <?php the_category(', '); ?></p>  
		</div> 
      </article></div>
<?php
	endwhile;
		...
		<figure class="latest-img"><?php get_the_image( array( 'meta_key' => array( 'thumbnail', 'thumbnail' ), 'size' => 'easyweb_webnus_latestfromblog' ) ); ?></figure>
			...
			<div class="latest-content">
				<h3 class="latest-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
				<p class="latest-author"><?php esc_html_e('by ','webnus-shortcodes'). the_author() . esc_html_e(' in ','webnus-shortcodes') . the_category(', '); ?></p>  
			</div> 
	    </article></div> <?php
				...
				<article class="latest-b8">
					...
					<div class="latest-b8-content">
						...
						<div class="latest-b8-meta">
							<div class="autho"><i class="sl-user"></i><span><?php esc_html_e( 'by: ', 'webnus-shortcodes' ); the_author_posts_link(); ?></span></div>
							<div class="date"><i class="sl-calendar"></i><span><?php echo get_the_date('d F Y'); ?></span></div>
							<div class="comments"><i class="sl-bubble"></i><span><?php echo get_comments_number(); ( get_comments_number() == 0 || get_comments_number() == 1 ) ? esc_html_e( ' Comment', 'webnus-shortcodes' ) : esc_html_e( ' Comments', 'webnus-shortcodes' ); ?></span></div>
						</div>
					</div>
				</article>
			</div>
				...
				<article class="latest-b9">
					...
					<div class="latest-b9-content">
						...
						<div class="latest-b9-meta">
							...
							<span class="categories"><?php esc_html_e( 'in ', 'webnus-shortcodes' ); the_category(', '); ?></span>
							<span class="comments"><?php echo get_comments_number(); ( get_comments_number() == 0 || get_comments_number() == 1 ) ? esc_html_e( ' Comment', 'webnus-shortcodes' ) : esc_html_e( ' Comments', 'webnus-shortcodes' ); ?></span>
						</div>
					</div>
				</article>
			</div>
			...
			<div class="col-sm-4">
				<article class="latest-b11">
					<div class="latest-b11-content">
						<h6 class="categories"><?php esc_html_e( 'In ', 'webnus-shortcodes' ); the_category(', '); ?></h6>
