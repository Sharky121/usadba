<?php
  ...
  */
  ...
  if ( class_exists( 'KEYDESIGN_ADDON_CLASS' ) ) {
    Redux::setExtensions( 'redux_ThemeTek', WP_PLUGIN_DIR . '/keydesign-addon/includes/redux-extensions/' );
  }
  ...
  Redux::setSection( $opt_name, array(
      ...
      'fields' => array(
        ...
        array(
            ...
            'type' => 'button_set',
            'title' => esc_html__('Displayed Date', 'sway'),
            'subtitle' => esc_html__('Display published or last updated date for blog posts.', 'sway'),
            'select2' => array('allowClear' => false, 'minimumResultsForSearch' => '-1'),
            'options'  => array(
