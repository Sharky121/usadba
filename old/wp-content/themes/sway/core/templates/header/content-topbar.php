...
if ( ! function_exists( 'sway_topbar_content' ) ) {
	function sway_topbar_content ( $topbar_section ) {
      ...
      if ( '' != sway_get_option( 'tek-business-phone' ) ) {
          ...
          $section_content .= '<span class="topbar-phone"><a href="tel:'. esc_attr( $secondary_business_phone ) .'"><i class="fa fa-whatsapp" aria-hidden="true"></i><span>'. esc_html( sway_get_option( 'tek-secondary-business-phone' ) ) .'</span></a></span>';
      }
